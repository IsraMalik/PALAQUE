...
if(($_SESSION['role'] != "petugas")){
  ...
  // if (isset($_POST['btn_keluar'])) {
  //   // <script>document.writeln(kodeKeluar)</script>
  //   $hh = $_GET['id_keluar'];
  //   mysqli_query($con, "UPDATE tb_daftar_parkir SET status ='2' WHERE kode = '$hh'");
  // }
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
                ...
                <img src="asset/img/logo.png" class="img-circle" alt="logo" style="float: left;margin-top: -10px;" width="45px"/>
                 <b style="float: left;margin-left: 4px;">PalaQUE</b>
                </div>
            ...
            <!-- Masuk Parkir -->
              ...
              <div class="col-md-5" style="margin-top: 30px">
                  <div class="col-md-10 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:25px;">
                      <div class="col-md-12">
                        <form class="cmxform" method="POST" action="home.php">
                          <div class="col-md-12">
                          ...
                          <input class="btn btn-primary col-md-12" type="button" value="Go"  name="btn_keluar" style="height: 40px" id="btnKeluar" style="height: 40px">
                          <!-- Modal -->
                          <div class="col-md-12">
                                      ...
                                      <div class="modal-body" style="padding-bottom: 10px;">
                                        <h3 id="plat"></h3>
                                            <div class="form-group"><label class="col-sm-2 control-label text-right" style="font-size:14pt">Total</label>
                                              <div class="col-sm-10">
                                                <input type="text" class="form-control android" name="total" id="total" onkeyup="sum();" readonly>
                                              </div>
                                            </div>
                                            <div class="form-group" style="margin-top: 14%;">
                                              <label class="col-sm-2 control-label text-right" style="font-size:14pt">Bayar</label>
                                              <div class="col-sm-10">
                                                <input type="text" class="form-control android" name="bayar" id="bayar" onkeyup="sum();" >
                                              </div>
                                            </div>
...
<script> 
  ...
  $("#btnKeluar").click(function(){
    var kodeKeluar = document.getElementById('kode_keluar').value;
    $.ajax({
    ...
    success:function(hasil){
      if(hasil != 0){
        $("#total").val(hasil);
        console.log(this.data, "total bayar=" + hasil)
      }else{
        console.log(this.data.kode, hasil)
        alert('hasil');
      }
    }
    });
...
//     var db = require("config/koneksi.php");
//   var kodeKeluar = document.getElementById("kode_keluar").value
//   const sql = `UPDATE tb_daftar_parkir
//            SET status='2'
//            WHERE kode='EP135'`;

// db_insert.query(sql, function (err, result) {
//     if (err) throw err;
