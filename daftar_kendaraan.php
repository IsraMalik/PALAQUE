...
<?php
  ...
  $cek_mobil = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tb_daftar_parkir WHERE jenis ='Mobil' AND status = '1'"));
  $cek_motor = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tb_daftar_parkir WHERE jenis ='Motor' AND status = '1'"));
  $cek_lainnya = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tb_daftar_parkir WHERE jenis ='Truk/Bus/Lainnya' AND status = '1'"));
 ?>
                  ...
                  <div class="col-md-12 panel">
                    ...
                    <tbody>
                      ...
                      <tr style="font-size: 11pt">
                        ...
                        <td><?php echo $data['jam_masuk'] . " WITA" ?></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
                  ...
                  <div class="col-md-12 panel">
                    ...
                    <tbody>
                      ...
                      <tr style="font-size: 11pt">
                        ...
                        <td><?php echo $data['merk'] ?></td>
                        <td><?php echo $data['jam_masuk'] . " WITA" ?></td>
                        <td><?php echo $data['jam_keluar'] . " WITA" ?></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
